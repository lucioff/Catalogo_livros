...
<html>
    <head>
        ...
        <title>registrar livro.jsp</title>
    </head>
    <body>
        <%
            ...
            if (livro.inserir(id_livro, titulo, autor, ano, preco, foto, id_editora))
                out.println("<h2>Livro registrado com sucesso</h2>");
                            
            else
                out.println("<h2>Erro ao registrar Livro</h2>");
